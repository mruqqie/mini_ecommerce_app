...
const variantStyles: Record<Variant, string> = {
  ...
  danger:
    "bg-gradient-to-br from-red-500 to-rose-500 text-white shadow-md hover:brightness-95",
...
export const IconButton = forwardRef<HTMLButtonElement, Omit<ButtonProps, "children">>(
  ({ variant = "ghost", size = "md", shape = "rounded", isLoading = false, leftIcon, className, ...rest }, ref) => {
    const classes = cx(
      base,
      variantStyles[variant],
